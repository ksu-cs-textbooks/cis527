...
* [Resource Type: User](https://docs.openvoxproject.org/openvox/latest/types/user.html) from OpenVox
* [Resource Tips and Examples: Package on Windows](https://docs.openvoxproject.org/openvox/latest/resources_package_windows.html) from OpenVox
...
* [Using User and Group on Windows](https://docs.openvoxproject.org/openvox/latest/resources_user_group_windows.html) from OpenVox
