...
For this lab, you'll need to have **ONE Windows 10 VM**, and **TWO Ubuntu 18.04 VMs** available. You may reuse existing VMs from Lab 1 or Lab 2. In either case, they should have the full expected configuration applied, either manually as in Lab 1 or via the Puppet Manifest files created for Lab 2.
...
On your Windows 10 VM, activate the **Remote Desktop** feature to allow remote access.
...
* [How to Change the Listening Port for Remote Desktop](https://support.microsoft.com/en-us/help/306759/how-to-change-the-listening-port-for-remote-desktop) from Microsoft Support
...
* [Changing the SSH Port for Your Linux Server](https://www.godaddy.com/help/changing-the-ssh-port-for-your-linux-server-7306) from GoDaddy
...
* _The Command Line Way: [Network Configuration](https://help.ubuntu.com/lts/serverguide/network-configuration.html) from Ubuntu Server Guide._
...
* [Dynamic Host Configuration Protocol (DHCP)](https://help.ubuntu.com/lts/serverguide/dhcp.html) from Ubuntu Server Guide
...
* [Wireshark 2.6 Available to Install in Ubuntu 18.04, 16.04 via PPA](http://ubuntuhandbook.org/index.php/2018/07/wireshark-2-6-available-install-ubuntu-18-04-ppa/) from UbuntuHandbook
